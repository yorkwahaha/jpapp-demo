...
2. `assets/css/settings.css?v=26050801`
3. `assets/css/mentor.css?v=26050801`
4. `assets/css/battle.css?v=26050801`
5. `assets/css/battle-vfx.css?v=26050801`
6. `assets/css/codex.css?v=26050801`
7. `assets/css/escape.css?v=26050801`
...
3. `assets/css/settings.css` - settings, system menu, shared modal controls
4. `assets/css/mentor.css` - mentor overlays, dialogue, prologue/portrait presentation
5. `assets/css/map.css` - map screen, map HUD, nodes, map ambience
6. `assets/css/battle.css` - battle screen base, HUD, HP/SP, question, options, resonance wheel
7. `assets/css/battle-vfx.css` - battle animations, boss death, hit, projectile, skill VFX
8. `assets/css/codex.css` - monster codex, spirit codex/book UI, unlock cards
9. `assets/css/rwd.css` - four-mode RWD overrides: iPhone, iPad portrait, iPad landscape, desktop
10. `assets/css/escape.css` - keep last until escape UI dependency is audited
...
| L1751-L1841 | Corner menu mobile | Mobile corner menu and in-battle menu states | Medium | `settings.css` | Maybe | Can move after confirming no map/battle-specific z-index regressions. |
...
Current task. Keep CSS behavior unchanged. Maintain this file as the working migration guide.
